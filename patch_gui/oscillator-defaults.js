// Generated from ui/shared/oscillator-defaults.ts by node ui/build.mjs. Do not edit this file directly.
...
export const OSCILLATOR_DEFAULT_VOLUME_NORMALIZED = (OSCILLATOR_DEFAULT_VOLUME_DB - OSCILLATOR_VOLUME_MIN_DB) / (OSCILLATOR_VOLUME_MAX_DB - OSCILLATOR_VOLUME_MIN_DB);
/** Init/new-sound mute values: A is audible; B and C are deliberately off. */
export const OSCILLATOR_DEFAULT_MUTE_BY_ID = Object.freeze({
    A: 0,
    B: 1,
    C: 1,
});
/** Resolve the canonical Init/new-sound mute value for one oscillator. */
export function getOscillatorDefaultMute(oscillatorID) {
