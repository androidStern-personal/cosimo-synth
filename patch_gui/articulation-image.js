 ...
 */
import { ARTICULATION_MAX_SLOTS, ARTICULATION_ROUTE_AMOUNT_INHERIT, ARTICULATION_ROUTE_AMOUNT_MAX_ABS, } from "./articulations.js";
...
function resolveRouteAmount(base, slot, routeId) {
 ...
 */
export function parseArticulationsV3(input, acceptedRouteIds) {
    if (!isObjectRecord(input)) {
 ...
 */
export function serializeArticulationsV3(state) {
    return {
        format: state.format,
