...
function resolveVoiceParameter(base, slot, parameterId) {
 ...
 */
export function resolveArticulationImage(base, slot) {
    ...
    return {
        ...
        enabled: true,
        framePositions: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.framePosition`)),
        pans: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.pan`)),
        octaves: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.octave`)),
        semitones: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.semitone`)),
        fineCents: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.fineCents`)),
        phases: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.phase`)),
        phaseRandoms: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.phaseRandom`)),
        retriggers: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.retrigger`)),
        volumeDbs: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.volumeDb`)),
        mutes: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.mute`)),
        solos: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.solo`)),
        warpModes: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.warpMode`)),
        warpAmounts: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.warpAmount`)),
        ...
        unisonVoices: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonVoices`)),
        unisonDetunes: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonDetune`)),
        unisonBlends: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonBlend`)),
        unisonWidths: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonWidth`)),
        unisonDetuneModes: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonDetuneMode`)),
        unisonStackModes: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonStackMode`)),
        unisonWavetablePositionSpreads: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonWavetablePositionSpread`)),
        unisonWarpSpreads: OSCILLATOR_IDS.map((oscillatorID) => resolveVoiceParameter(base, slot, `osc${oscillatorID}.unisonWarpSpread`)),
        msegMorphs: [
 ...
 */
export function resolveArticulationImages(base, state) {
 ...
 */
export function affectedSelectors(change, state) {
    switch (change.kind) {
        case "voiceParameter":
            return state.slots
