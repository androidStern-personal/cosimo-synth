...
import { MSEG_RATE_MAX_SECONDS, clamp01, createDefaultMsegPlayback, createDefaultMsegShape, msegShapesEqual, normalizeMsegPlayback, normalizeMsegShape, renderMsegShape, } from "./mseg.js";
...
export function createAvailableGeneratedRouteId(routes) {
...
export function normalizeEnvelopeSlot(value, slotIndex = 0) {
...
export function buildModulationRuntimeEvents(state, previousState = null, curveCommand) {
    const events = [];
