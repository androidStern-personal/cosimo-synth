...
const definitions = [
    ...
    },
    {
        ...
        lifecycle: "gesture",
        parameters: [
            parameter("durationScale", "Stop Time", 0.05, 4, 1, 0.01, { unit: "x", latch: "trigger" }),
            parameter("startCurve", "Start Curve", 0.25, 4, 1, 0.01),
            parameter("endCurve", "End Curve", 0.25, 4, 1, 0.01),
            parameter("catchupPercent", "Catch Up", 0, 100, 25, 1, { unit: "%" }),
            parameter("mode", "Mode", 0, 1, 0, 1, { latch: "trigger", auxEligible: false, integer: true, options: ["Stop", "Spin Up"] }),
        ],
    },
    {
