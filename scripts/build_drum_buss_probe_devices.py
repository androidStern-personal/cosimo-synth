...
def build_recorder() -> dict:
    ...
    boxes = [
        box("obj-comment", "comment", "ProbeRecorder: records input to fixed WAV after M4L device-ready", [24.0, 16.0, 430.0, 20.0], numoutlets=0),
        live_text("obj-record", "probe_record", "Record", [24.0, 48.0, 72.0, 24.0]),
        box("obj-in", "newobj", "plugin~", [24.0, 88.0, 56.0, 20.0], numoutlets=2),
        box("obj-loadbang", "newobj", "loadbang", [112.0, 88.0, 60.0, 20.0]),
        box("obj-auto-open-delay", "newobj", "delay 500", [184.0, 56.0, 68.0, 20.0]),
        box("obj-auto-start-delay", "newobj", "delay 1200", [264.0, 56.0, 72.0, 20.0]),
        box("obj-auto-stop-delay", "newobj", "delay 12000", [344.0, 56.0, 74.0, 20.0]),
        ...
        box("obj-load-start-trigger", "newobj", "trigger b b", [512.0, 88.0, 70.0, 20.0], numoutlets=2),
        ...
        box("obj-start", "message", "record 10000", [24.0, 152.0, 86.0, 20.0]),
    ...
    lines = [
        ...
        line("obj-loadbang", 0, "obj-load-start-trigger", 0),
        line("obj-load-start-trigger", 1, "obj-open", 0),
        line("obj-load-start-trigger", 0, "obj-start", 0),
        line("obj-loadbang", 0, "obj-open", 0),
        line("obj-loadbang", 0, "obj-auto-open-delay", 0),
        line("obj-loadbang", 0, "obj-auto-start-delay", 0),
        line("obj-loadbang", 0, "obj-auto-stop-delay", 0),
        line("obj-auto-open-delay", 0, "obj-open", 0),
        line("obj-auto-start-delay", 0, "obj-start", 0),
        line("obj-auto-stop-delay", 0, "obj-stop", 0),
        line("obj-rec-start-recv", 0, "obj-open", 0),
        line("obj-rec-start-recv", 0, "obj-manual-start-delay", 0),
        line("obj-manual-start-delay", 0, "obj-start", 0),
        line("obj-rec-stop-recv", 0, "obj-stop", 0),
        line("obj-record", 0, "obj-sel", 0),
        line("obj-sel", 0, "obj-open", 0),
        line("obj-sel", 0, "obj-manual-start-delay", 0),
        line("obj-sel", 1, "obj-stop", 0),
