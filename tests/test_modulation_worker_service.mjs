...
const laneTails = [
    ...
    },
    {
        ...
        // Rack cell indices run at the bus width (static 47 + four pool
        // mirror sets = 235): final static voiceRack pair = 9*235 + 46.
        expected: { count: 470, cellIndex: 2161, sourceIndex: 9, targetIndex: 46, polarity: 0 },
    },
    {
        ...
        // Final static macroRack pair = 3*235 + 46.
        expected: { count: 188, cellIndex: 751, sourceIndex: 3, targetIndex: 46, polarity: 0 },
    },
];
...
test("the modulation service publishes serialized all-1484 state through one correlated runtime frontier", async () => {
