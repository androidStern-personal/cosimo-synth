...
test("seqfx_adapter_contract_registers_required_seqfx_v1_state", () => {
...
test("seqfx_adapter_apply_writes_seqfx_v1_and_uploads_selected_pattern_authoritative", () => {
    let state = createDefaultSeqFxState();
    state = applySeqFxCellToggle(state, {
        patternIndex: 4,
    ...
    assert.equal(connection.storedWrites.at(-1).key, "seqfx.v1");
