...
- Owner: Andrew's direct workshop task `Prototype SeqFX effect card workshop`, thread `01a05dc0-7231-7bb1-81ee-c57145c292f5`, branch `codex/seqfx-effect-card-workshop`, worktree `/Users/winterfell/.codex/worktrees/eedc/cosimo-synth`, exact base `52bfbe7a15fb15da58ff7747737139a9f9ed7540`, model `gpt-5.6-sol`, reasoning `xhigh`. This task reports directly to Andrew in its own task and is not part of Bob's engineering queue.
...
- Before handoff, use decision-provenance to report any choice that changes the approved card, interaction ownership, or prototype isolation. Commit a clean throwaway-branch checkpoint, launch the isolated browser harness for Andrew, and report the result directly in the workshop task. Bob (`01a05c09-ce2d-7120-bc44-cd8102a2f0d7`) is explicitly excluded: he must not guide, review, message, request repairs, rebase, merge, push, run, or otherwise coordinate this prototype unless Andrew later reassigns it.
