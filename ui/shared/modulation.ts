...
export function buildDisplayedMsegState(bridge: {
    getMsegSlotController(slotIndex: number): Pick<MsegEditorControllerLike, "getState">;
}, slotIndex: number): MsegState | null {
