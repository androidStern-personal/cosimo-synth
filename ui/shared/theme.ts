...
export type PatchTheme = {
    ...
    panelStroke: string;
    frameBlueRGB: RGBColor;
    accentBlue: string;
    accentBlueRGB: RGBColor;
    accentBlueDeep: string;
    accentBlueDeepRGB: RGBColor;
    guideBlue: string;
    warmText: string;
    warmTextRGB: RGBColor;
    highlightPink: string;
    highlightPinkRGB: RGBColor;
    shadowColor: string;
};

export type WavetableTheme = {
    backgroundTop: string;
    backgroundBottom: string;
    backgroundRGB: RGBColor;
    panelStroke: string;
...
export const DEFAULT_PATCH_THEME: PatchTheme = {
...
export function getPatchThemeCSSVariables(theme: PatchTheme = DEFAULT_PATCH_THEME): Record<string, string> {
    return {
...
export function createDefaultWavetableTheme(theme: PatchTheme = DEFAULT_PATCH_THEME): WavetableTheme {
    return {
