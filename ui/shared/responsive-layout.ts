export type ResponsivePatchLayout = {
    isCompact: boolean;
    headerStacks: boolean;
    gridTemplateColumns: string;
    controlStyle: "knob" | "scan-rail";
    noteCount: number;
...
export function getLayoutCSSVariables(layout: ResponsivePatchLayout): Record<string, string> {
    return {
