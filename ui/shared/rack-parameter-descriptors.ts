...
export type RackParameterDescriptor = {
     ...
     * whose base rests near one end of a wide amount domain (resonance), where
     * the linear sweep slams the audible floor in a few pixels and banks dead
     * clamped amount for the rest of the travel.
     */
    readonly modulationDragStyle?: "effective-value";
};
...
const definitions: ReadonlyArray<Omit<RackEffectDescriptor, "parameters"> & { readonly parameters: ReadonlyArray<RackParameterDescriptor> }> = [
    ...
    },
    {
        ...
        parameters: [
            ...
            p("drive", "distortionWetHPHz", "Wet High-pass", "HP", 20, 4_000, 20, { unit: "Hz", scale: "log", modulationTargetIndex: 6, modulationApplication: "octaves" }),
            p("drive", "distortionWetLPHz", "Wet Low-pass", "LP", 20, 20_000, 20_000, { unit: "Hz", scale: "log", modulationTargetIndex: 7, modulationApplication: "octaves" }),
